...
<div class="card">
    <div class="card-header">
        <form action="{{ route('users.search') }}" class="form form-inline" method="POST">
            @csrf
            <input type="filter" name="filter" placeholder="Filtrar:" class="form-control"
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width: 10px;">
                        ...
                        <a href="{{ route('users.roles', $user->id) }}" class="btn btn-info" title="Cargos"><i
                                class="fas fa-address-card"></i> Cargos</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
